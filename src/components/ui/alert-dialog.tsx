  ...
  return (
    <AlertDialogPortal container={container}>
      ...
      <AlertDialogPrimitive.Content
        ...
        // h-full sm:h-auto sm:max-h-[calc(100%-2rem)]
        // rounded-none sm:rounded-lg
        className={cn(
          "top-[50%] left-[50%] z-50 fixed gap-4 grid bg-background shadow-lg p-6 border rounded-lg w-full max-w-[calc(100%-1rem)] sm:max-w-lg max-h-[calc(100%-1rem)] translate-x-[-50%] translate-y-[-50%] data-[state=closed]:animate-out data-[state=open]:animate-in duration-200 data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
          className
        )}
        {...props}
      />
